...
\begin{document}
  \begin{center}
    ...
    \href{mailto:me@zachbayl.in}{\faEnvelope \hspace{1pt} me@zachbayl.in} \hspace{4pt} \faPhone \hspace{1pt} (770) 722-8911 \hspace{4pt} \faIcon{map-marker-alt} Atlanta, GA \hspace{4pt} \href{https://linkedin.com/in/zbaylin}{\faLinkedin \hspace{1pt} zbaylin} \hspace{4pt} \href{https://github.com/zbaylin}{\faGithub \hspace{1pt} zbaylin} \hspace{4pt} \href{http://zachbayl.in}{\faGlobeAmericas \hspace{1pt} zachbayl.in}\\
  \end{center}
